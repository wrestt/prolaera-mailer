...
describe('EventInfo Component', () => {
  ...
  it('checks all custom inputs', async () => {
    ...
    expect(
      wrapper.contains(
        <ul>
          <li style={{ padding: '5px', marginTop: '0px' }}>Auditing - 12 Hour(s)</li>
          <li style={{ padding: '5px', marginTop: '0px' }}>Uncategorized - 4 Hour(s)</li>
          <li style={{ padding: '5px', marginTop: '0px' }}>Other - 0.1 Hour(s)</li>
        </ul>
      )
    ).toBe(true);
