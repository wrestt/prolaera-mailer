...
var _courseAssignedBuilder = require('../builders/courseAssignedBuilder');
...
describe('courseAssigned Email', function() {
  var logoUrl = 'https://assets.prolaera.com/prolaeraLogo_fullText.png';
  it(
    'returns courseAssigned email html',
    _asyncToGenerator(
          ...
          function _callee$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.next = 2;
                  return (0, _courseAssignedBuilder2.default)(_completeCourse2.default, logoUrl);
  ...
  it(
    ...
    _asyncToGenerator(
      /*#__PURE__*/ regeneratorRuntime.mark(function _callee2() {
        var emailHtml, emailComponent, courseAssignedJson;
        return regeneratorRuntime.wrap(
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 2:
                  ...
                  courseAssignedJson = emailComponent.toJSON();
            ...
            while (1) {
              switch ((_context3.prev = _context3.next)) {
                ...
                case 2:
                  ...
                  _context3.next = 5;
                  return (0, _writeFileHelper2.default)(email, 'courseAssignedTest.html');
