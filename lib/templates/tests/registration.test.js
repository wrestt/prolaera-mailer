...
var _eventRegistrationBuilder = require('../builders/eventRegistrationBuilder');
...
describe('registration Email', function() {
  var logoUrl = 'https://assets.prolaera.com/prolaeraLogo_fullText.png';
  it(
    'returns registration subHeader email html',
    _asyncToGenerator(
          ...
          function _callee$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.next = 2;
                  return (0, _eventRegistrationBuilder2.default)(_event2.default, logoUrl);
            ...
            while (1) {
              switch ((_context3.prev = _context3.next)) {
                ...
                case 2:
                  ...
                  _context3.next = 5;
                  return (0, _writeFileHelper2.default)(email, 'eventTest.html');
