...
var _eventCertificateBuilder = require('../builders/eventCertificateBuilder');
          ...
          function _callee$(_context) {
            while (1) {
              switch ((_context.prev = _context.next)) {
                case 0:
                  _context.next = 2;
                  return (0, _eventCertificateBuilder2.default)(
                    _event2.default,
            ...
            while (1) {
              switch ((_context2.prev = _context2.next)) {
                ...
                case 2:
                  ...
                  _context2.next = 5;
                  return (0, _writeFileHelper2.default)(email, 'eventCertificateTest.html');
