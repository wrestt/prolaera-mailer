...
var eventCertificateEmail = (function() {
  var _ref = _asyncToGenerator(
    /*#__PURE__*/ regeneratorRuntime.mark(function _callee(event, user, certificate, imageUrl) {
      var Header;
                ...
                return _context.abrupt(
                  ...
                  (0, _reactHtmlEmail.renderEmail)(
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement(
                        Header,
                        _extends({ text: 'Complete Evaluation' }, event, certificate)
                      ),
                      _react2.default.createElement(
                        _SubHeader2.default,
                        _extends({}, user, { subText: 'You have received a', header: 'Certificate' })
                      ),
                      _react2.default.createElement(_eventCertificate2.default, _extends({}, event, user, certificate)),
