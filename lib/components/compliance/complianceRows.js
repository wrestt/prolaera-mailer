...
var ComplianceRows = (function(_React$Component) {
  _inherits(ComplianceRows, _React$Component);

  function ComplianceRows() {
    _classCallCheck(this, ComplianceRows);

    return _possibleConstructorReturn(
      this,
      (ComplianceRows.__proto__ || Object.getPrototypeOf(ComplianceRows)).apply(this, arguments)
    );
  }

  _createClass(ComplianceRows, [
    {
      key: 'render',
      value: function render() {
        ...
        var categories = Object.keys(flatCompliance.applied).filter(function(key) {
          return key !== 'total';
        });
        return _react2.default.createElement(
          ...
          categories.map(function(category, index) {
            return _react2.default.createElement(
              ...
              _extends({ category: category, index: index, key: index }, _this2.props)
            );
          })
        );
      }
