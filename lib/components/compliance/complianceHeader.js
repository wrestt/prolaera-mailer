...
var ComplianceHeader = (function(_React$Component) {
  _inherits(ComplianceHeader, _React$Component);

  function ComplianceHeader() {
    _classCallCheck(this, ComplianceHeader);

    return _possibleConstructorReturn(
      this,
      (ComplianceHeader.__proto__ || Object.getPrototypeOf(ComplianceHeader)).apply(this, arguments)
    );
  }

  _createClass(ComplianceHeader, [
    {
      key: 'render',
