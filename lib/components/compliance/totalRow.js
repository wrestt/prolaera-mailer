...
var TotalRow = (function(_React$Component) {
  _inherits(TotalRow, _React$Component);

  function TotalRow() {
    _classCallCheck(this, TotalRow);

    return _possibleConstructorReturn(
      this,
      (TotalRow.__proto__ || Object.getPrototypeOf(TotalRow)).apply(this, arguments)
    );
  }

  _createClass(TotalRow, [
    {
      key: 'render',
