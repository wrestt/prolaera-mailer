...
var _courseCertificate = require('../certificate/courseCertificate');
...
describe('CourseCertificate component', function() {
  it(
              ...
              switch ((_context.prev = _context.next)) {
                case 0:
                  certificate = _reactTestRenderer2.default.create(
                    _react2.default.createElement(_courseCertificate2.default, null)
                  );
                  certString = (0, _stringify2.default)(certificate.toJSON());
                  containsDefault = certString.includes('View Certificate');
              ...
              switch ((_context2.prev = _context2.next)) {
                case 0:
                  wrapper = (0, _enzyme.shallow)(
                    _react2.default.createElement(_courseCertificate2.default, certificate)
                  );
                      ...
                      _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                          ...
                          _react2.default.createElement(
                            'h6',
                            { style: { marginTop: '0px' } },
                            'Instructor: Elon Musk (Group-Live)'
                          )
                        )
                      )
                    )
